...
export default function TransliteratorDeseret({ title }: TransliteratorProps) {
  ...
  const handleChange = (currentText: string): void => {
    ...
    for (const word of words) {
      const processed = processDeseretText(word);
        ...
        <div className="textarea-wrapper">
          <div
            ...
            className={`transliteration-output ${
              textareaHasText ? (title === "Deseret" ? "deseret-font" : "") : ""
            }`}
          >
            {transliteratedText}
          </div>
