...
import { BAYBAYIN_CONSONANTS, BAYBAYIN_VOWELS } from "./BAYBAYIN_DATA";
import {
 ...
 */
function letterKey(id: string, glyph: string): KeyboardLayout[number][number] {
...
/** On-screen Baybayin alphabet layout (shift/caps for capitals). */
